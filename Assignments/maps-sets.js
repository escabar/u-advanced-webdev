class MessageBoard {
    ...
    */
    ...
    addMessage(data){
        this.messages.set(this.id, data);
        this.id ++;
        return this;
    }
    ...
    */
    ...
    findMessageByValue(data){
        for(let [key, val] of this.messages){
            if(val === data){
    ...
    /*
    Add a method called removeMessage which accepts a number and removes a message in the messages map with a key 
...
function uniqueValues(arr){
    let tempSet= new Set();
    arr.forEach(element => { tempSet.add(element)});
    return tempSet.size;
